...
It can be used automatically generate Darwin Core [Event](https://dwc.tdwg.org/terms/#event) and [Location](https://dwc.tdwg.org/terms/#location) terms from your data set for submission to a Darwin Core Archive (e.g. [GBIF](https://www.gbif.org/) and [ALA](https://www.ala.org.au/)).
