test_that("dwc_coordinateUncertaintyInMeters works for single values", {
  expect_equal(dwc_coordinateUncertaintyInMeters(
    decimalLatitude = -41.17472,
...
test_that("dwc_coordinateUncertaintyInMeters works for multiple values", {
  ...
  thylacine_data_extended <-
    ...
    dplyr::mutate(coordinateUncertaintyInMeters = dwc_coordinateUncertaintyInMeters(
  ...
  expect_equal(
    thylacine_data_extended |> dplyr::pull(coordinateUncertaintyInMeters),
    base::rep(31, 8)
  )
})
