...
**Warning:** The `dwc_country_to_county()` function differs to the other `dwcPrepare` functions in two ways. First, is not wrapped in `dplyr::mutate()` when applying to a dataframe. Also, column names are given as strings. We may update this in a future version of the package.
