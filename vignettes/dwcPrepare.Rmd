...
thylacine_data_a <- 
  thylacine_data |>
  mutate(
    dwc_coordinates(longitude = longitude_ddm, 
...
thylacine_data_b <- 
  thylacine_data_a |>
  mutate(coordinatePrecision =
           dwc_coordinatePrecision(verbatimLatitude = verbatimLatitude,
